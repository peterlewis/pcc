...
function findWasmBinary() {
  if (Module["locateFile"]) {
    return locateFile("fwdbg.wasm");
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL("fwdbg.wasm", import.meta.url).href;
}
...
function _CDC_Copy_Transmit() {
  return 0;
}

function _FATFS_remount() {
  return 0;
}

function _HAL_ADCEx_Calibration_Start() {
  return 0;
}

function _HAL_ADCEx_MultiModeConfigChannel() {
  return 0;
}

function _HAL_ADC_ConfigChannel() {
  return 0;
}

function _HAL_ADC_GetValue() {
  return 2048;
}

function _HAL_ADC_Init() {
  return 0;
}

function _HAL_ADC_PollForConversion() {
  return 0;
}

function _HAL_ADC_Start() {
  return 0;
}

function _HAL_CRC_Init() {
  return 0;
}

function _HAL_DAC_ConfigChannel() {
  return 0;
}

function _HAL_DAC_Init() {
  return 0;
}

function _HAL_DAC_SetValue() {
  return 0;
}

function _HAL_DAC_Start_DMA() {
  return 0;
}

function _HAL_DMA_Abort() {
  return 0;
}

function _HAL_DMA_Start() {
  return 0;
}
...
function _HAL_GPIO_Init() {
  return 0;
}

function _HAL_GPIO_WritePin() {
  return 0;
}
...
function _HAL_NVIC_EnableIRQ() {
  return 0;
}

function _HAL_NVIC_SetPriority() {
  return 0;
}

function _HAL_PWREx_ControlVoltageScaling() {
  return 0;
}

function _HAL_PWR_EnableBkUpAccess() {
  return 0;
}

function _HAL_QSPI_Init() {
  return 0;
}

function _HAL_RCCEx_EnableMSIPLLMode() {
  return 0;
}

function _HAL_RCCEx_PeriphCLKConfig() {
  return 0;
}

function _HAL_RCC_ClockConfig() {
  return 0;
}

function _HAL_RCC_OscConfig() {
  return 0;
}

function _HAL_RTC_GetDate() {
  return 0;
}

function _HAL_RTC_GetTime() {
  return 0;
}

function _HAL_RTC_Init() {
  return 0;
}

function _HAL_TIMEx_MasterConfigSynchronization() {
  return 0;
}

function _HAL_TIM_Base_Init() {
  return 0;
}

function _HAL_TIM_Base_Start() {
  return 0;
}

function _HAL_TIM_ConfigClockSource() {
  return 0;
}

function _HAL_TIM_MspPostInit() {
  return 0;
}

function _HAL_TIM_OC_ConfigChannel() {
  return 0;
}

function _HAL_TIM_OC_Init() {
  return 0;
}

function _HAL_TIM_PWM_ConfigChannel() {
  return 0;
}

function _HAL_TIM_PWM_Init() {
  return 0;
}

function _HAL_TIM_PWM_Start() {
  return 0;
}

function _HAL_UART_AbortTransmit() {
  return 0;
}

function _HAL_UART_Init() {
  return 0;
}

function _HAL_UART_Receive_DMA() {
  return 0;
}

function _HAL_UART_Transmit() {
  return 0;
}

function _HAL_UART_Transmit_DMA() {
  return 0;
}

function _MX_FATFS_Init() {
  return 0;
}

function _MX_USB_DEVICE_Init() {
  return 0;
}

function _MX_USB_Stop() {
  return 0;
}
...
function _firmwareCheckOnEject() {
  return 0;
}
...
var _emu_set_time = Module["_emu_set_time"] = makeInvalidEarlyAccess("_emu_set_time");

var _emu_seg_c = Module["_emu_seg_c"] = makeInvalidEarlyAccess("_emu_seg_c");

var _emu_seg_b = Module["_emu_seg_b"] = makeInvalidEarlyAccess("_emu_seg_b");

var _emu_MODE_LST = Module["_emu_MODE_LST"] = makeInvalidEarlyAccess("_emu_MODE_LST");

var _emu_set_pos = Module["_emu_set_pos"] = makeInvalidEarlyAccess("_emu_set_pos");

var _emu_enter_alt = Module["_emu_enter_alt"] = makeInvalidEarlyAccess("_emu_enter_alt");

var _emu_alt_update = Module["_emu_alt_update"] = makeInvalidEarlyAccess("_emu_alt_update");
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports["emu_set_time"] != "undefined", "missing Wasm export: emu_set_time");
  assert(typeof wasmExports["emu_seg_c"] != "undefined", "missing Wasm export: emu_seg_c");
  assert(typeof wasmExports["emu_seg_b"] != "undefined", "missing Wasm export: emu_seg_b");
  assert(typeof wasmExports["emu_MODE_LST"] != "undefined", "missing Wasm export: emu_MODE_LST");
  assert(typeof wasmExports["emu_set_pos"] != "undefined", "missing Wasm export: emu_set_pos");
  assert(typeof wasmExports["emu_enter_alt"] != "undefined", "missing Wasm export: emu_enter_alt");
  assert(typeof wasmExports["emu_alt_update"] != "undefined", "missing Wasm export: emu_alt_update");
  ...
  _emu_set_time = Module["_emu_set_time"] = createExportWrapper("emu_set_time", wasmExports["emu_set_time"], 1);
  _emu_seg_c = Module["_emu_seg_c"] = createExportWrapper("emu_seg_c", wasmExports["emu_seg_c"], 0);
  _emu_seg_b = Module["_emu_seg_b"] = createExportWrapper("emu_seg_b", wasmExports["emu_seg_b"], 1);
  _emu_MODE_LST = Module["_emu_MODE_LST"] = createExportWrapper("emu_MODE_LST", wasmExports["emu_MODE_LST"], 0);
  _emu_set_pos = Module["_emu_set_pos"] = createExportWrapper("emu_set_pos", wasmExports["emu_set_pos"], 2);
  _emu_enter_alt = Module["_emu_enter_alt"] = createExportWrapper("emu_enter_alt", wasmExports["emu_enter_alt"], 1);
  _emu_alt_update = Module["_emu_alt_update"] = createExportWrapper("emu_alt_update", wasmExports["emu_alt_update"], 0);
...
var wasmImports = {
  /** @export */ CDC_Copy_Transmit: _CDC_Copy_Transmit,
  /** @export */ FATFS_remount: _FATFS_remount,
  /** @export */ HAL_ADCEx_Calibration_Start: _HAL_ADCEx_Calibration_Start,
  /** @export */ HAL_ADCEx_MultiModeConfigChannel: _HAL_ADCEx_MultiModeConfigChannel,
  /** @export */ HAL_ADC_ConfigChannel: _HAL_ADC_ConfigChannel,
  /** @export */ HAL_ADC_GetValue: _HAL_ADC_GetValue,
  /** @export */ HAL_ADC_Init: _HAL_ADC_Init,
  /** @export */ HAL_ADC_PollForConversion: _HAL_ADC_PollForConversion,
  /** @export */ HAL_ADC_Start: _HAL_ADC_Start,
  /** @export */ HAL_CRC_Init: _HAL_CRC_Init,
  /** @export */ HAL_DAC_ConfigChannel: _HAL_DAC_ConfigChannel,
  /** @export */ HAL_DAC_Init: _HAL_DAC_Init,
  /** @export */ HAL_DAC_SetValue: _HAL_DAC_SetValue,
  /** @export */ HAL_DAC_Start_DMA: _HAL_DAC_Start_DMA,
  /** @export */ HAL_DMA_Abort: _HAL_DMA_Abort,
  /** @export */ HAL_DMA_Start: _HAL_DMA_Start,
  /** @export */ HAL_Delay: _HAL_Delay,
  /** @export */ HAL_GPIO_Init: _HAL_GPIO_Init,
  /** @export */ HAL_GPIO_WritePin: _HAL_GPIO_WritePin,
  /** @export */ HAL_IncTick: _HAL_IncTick,
  /** @export */ HAL_Init: _HAL_Init,
  /** @export */ HAL_NVIC_EnableIRQ: _HAL_NVIC_EnableIRQ,
  /** @export */ HAL_NVIC_SetPriority: _HAL_NVIC_SetPriority,
  /** @export */ HAL_PWREx_ControlVoltageScaling: _HAL_PWREx_ControlVoltageScaling,
  /** @export */ HAL_PWR_EnableBkUpAccess: _HAL_PWR_EnableBkUpAccess,
  /** @export */ HAL_QSPI_Init: _HAL_QSPI_Init,
  /** @export */ HAL_RCCEx_EnableMSIPLLMode: _HAL_RCCEx_EnableMSIPLLMode,
  /** @export */ HAL_RCCEx_PeriphCLKConfig: _HAL_RCCEx_PeriphCLKConfig,
  /** @export */ HAL_RCC_ClockConfig: _HAL_RCC_ClockConfig,
  /** @export */ HAL_RCC_OscConfig: _HAL_RCC_OscConfig,
  /** @export */ HAL_RTC_GetDate: _HAL_RTC_GetDate,
  /** @export */ HAL_RTC_GetTime: _HAL_RTC_GetTime,
  /** @export */ HAL_RTC_Init: _HAL_RTC_Init,
  /** @export */ HAL_TIMEx_MasterConfigSynchronization: _HAL_TIMEx_MasterConfigSynchronization,
  /** @export */ HAL_TIM_Base_Init: _HAL_TIM_Base_Init,
  /** @export */ HAL_TIM_Base_Start: _HAL_TIM_Base_Start,
  /** @export */ HAL_TIM_ConfigClockSource: _HAL_TIM_ConfigClockSource,
  /** @export */ HAL_TIM_MspPostInit: _HAL_TIM_MspPostInit,
  /** @export */ HAL_TIM_OC_ConfigChannel: _HAL_TIM_OC_ConfigChannel,
  /** @export */ HAL_TIM_OC_Init: _HAL_TIM_OC_Init,
  /** @export */ HAL_TIM_PWM_ConfigChannel: _HAL_TIM_PWM_ConfigChannel,
  /** @export */ HAL_TIM_PWM_Init: _HAL_TIM_PWM_Init,
  /** @export */ HAL_TIM_PWM_Start: _HAL_TIM_PWM_Start,
  /** @export */ HAL_UART_AbortTransmit: _HAL_UART_AbortTransmit,
  /** @export */ HAL_UART_Init: _HAL_UART_Init,
  /** @export */ HAL_UART_Receive_DMA: _HAL_UART_Receive_DMA,
  /** @export */ HAL_UART_Transmit: _HAL_UART_Transmit,
  /** @export */ HAL_UART_Transmit_DMA: _HAL_UART_Transmit_DMA,
  /** @export */ MX_FATFS_Init: _MX_FATFS_Init,
  /** @export */ MX_USB_DEVICE_Init: _MX_USB_DEVICE_Init,
  /** @export */ MX_USB_Stop: _MX_USB_Stop,
  ...
  /** @export */ alignfault,
  /** @export */ doDateUpdate: _doDateUpdate,
  /** @export */ emscripten_resize_heap: _emscripten_resize_heap,
  /** @export */ f_close: _f_close,
  /** @export */ f_lseek: _f_lseek,
  /** @export */ f_open: _f_open,
  /** @export */ f_read: _f_read,
  /** @export */ f_stat: _f_stat,
  /** @export */ fd_close: _fd_close,
  /** @export */ fd_seek: _fd_seek,
  /** @export */ fd_write: _fd_write,
  /** @export */ firmwareCheckOnEject: _firmwareCheckOnEject,
  /** @export */ segfault
};
