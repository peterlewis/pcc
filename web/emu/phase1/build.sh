...
"_emu_flags","_emu_data_valid","_emu_had_pps","_emu_since_pps","_emu_satcount","_emu_digit_fade","_emu_holdover_u_us","_emu_tc_probe","_emu_config_done","_emu_tc_fill","_emu_tc_refit","_emu_cuckoo_active","_emu_cuckoo_level","_emu_cuckoo_set","_emu_MODE_CUCKOO_SHOWCASE","_emu_adev_reset","_emu_adev_push","_emu_adev_reduce","_emu_adev_sigma","_emu_adev_noctave","_emu_MODE_ADEV","_emu_adev_line","_emu_render_mode","_emu_MODE_STAR","_emu_star_line","_emu_lst","_emu_set_pos","_emu_star_count","_emu_star_ra","_emu_star_dec","_emu_menu_event","_emu_menu_tick","_emu_menu_layer","_emu_menu_idx","_emu_menu_modecount","_emu_ee_reset","_emu_ee_load","_emu_ee_commit","_emu_ee_apply","_emu_ovr_clear","_emu_ovr_valid","_emu_set_mtime","_emu_cfg_defined","_emu_brightness","_emu_set_brightness","_emu_ee_peek","_emu_ee_poke","_emu_menu_dirty","_emu_menu_reset","_emu_ee2_reset","_emu_ee2_load","_emu_ee2_commit","_emu_ee2_peek","_emu_ee2_poke","_emu_tc_persist_set","_emu_tc_seed_flag","_emu_cfg_tc_defined","_emu_tc_forget","_emu_tc_model_dirty","_emu_tc_model_check","_emu_tc_model_supported","_emu_tc_set_model","_emu_tc_clear_model","_emu_tc_seed_boot","_emu_tc2_probe","_malloc","_free"]'
